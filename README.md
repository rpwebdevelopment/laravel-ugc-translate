...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-ugc-translate.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-ugc-translate)
...
```bash
php artisan vendor:publish --tag="laravel-ugc-translate-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-ugc-translate-config"
```
...
```bash
php artisan vendor:publish --tag="laravel-ugc-translate-views"
```

## Usage

```php
$laravelUgcTranslate = new RpWebDevelopment\LaravelUgcTranslate();
echo $laravelUgcTranslate->echoPhrase('Hello, RpWebDevelopment!');
```
