@if($ugcModel)
    <div>
        ...
        <div style="position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; z-index: 1000; {{ $displayStyle }}">
            ...
            <div style="position: absolute; top: 20vh; padding: 20px; width: 50%; left: 25%; background: #FFFFFF; border-radius: 10px; z-index: 10001;">
